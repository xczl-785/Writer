...
export const useFileTreeStore = create<FileTreeState & FileTreeActions>(
  (set) => ({
    ...
    addRootFolder: (folder) => set((state) => ({
    ...
    updateRootFolderName: (path, name) => set((state) => ({
    ...
    setLoadingPath: (path, loading) => set((state) => {
    ...
    setErrorPath: (path, error) => set((state) => {
