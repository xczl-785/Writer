...
export const MESSAGES: Record<AppLocale, Messages> = {
  'zh-CN': {
    ...
    'menu.help.about': '?? Writer',
    'aboutWriter.title': 'Writer',
    'aboutWriter.iconAlt': 'Writer ??',
    'aboutWriter.subtitle': '??????? Markdown ???',
    'aboutWriter.currentVersion': '???? {version}',
    'aboutWriter.close': '??',
    'aboutWriter.buildInfo': '????',
    'aboutWriter.versionLabel': '????',
    'aboutWriter.platformLabel': '???',
    'aboutWriter.platformValue': 'Windows Desktop',
    'aboutWriter.stackLabel': '???',
    'aboutWriter.stackValue': 'Tauri 2 + React 19',
    'aboutWriter.positioningTitle': '????',
    'aboutWriter.positioningBody': '?????????????????????????????????????????',
    'aboutWriter.more': '????',
    'aboutWriter.comingSoon': '?????',
    'aboutWriter.releaseNotes.title': '????',
    'aboutWriter.releaseNotes.desc': '?????????????????',
    'aboutWriter.documentation.title': '????',
