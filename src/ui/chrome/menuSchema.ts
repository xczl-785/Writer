...
export const WINDOWS_MENU_SCHEMA: MenuSchemaGroup[] = [
  {
    ...
    items: [
      ...
      {
        id: 'separator.file.2',
        labelKey: 'separator.file.2',
        fallbackLabels: { 'zh-CN': '工作区', 'en-US': 'Workspace' },
        separator: true,
      },
      {
        id: 'separator.file.3',
        labelKey: 'separator.file.3',
      ...
      {
        id: 'separator.file.4',
        labelKey: 'separator.file.4',
        fallbackLabels: { 'zh-CN': '关闭', 'en-US': 'Close' },
        separator: true,
      },
      {
    ...
    items: [
      {
        ...
        fallbackLabels: { 'zh-CN': '撤销', 'en-US': 'Undo' },
        accelerator: 'Ctrl+Z',
      },
      {
        id: 'menu.edit.redo',
        labelKey: 'menu.edit.redo',
        fallbackLabels: { 'zh-CN': '重做', 'en-US': 'Redo' },
        accelerator: 'Ctrl+Y',
      },
      {
        id: 'separator.edit.1',
        labelKey: 'separator.edit.1',
        fallbackLabels: { 'zh-CN': '', 'en-US': '' },
        separator: true,
      },
      {
        ...
        fallbackLabels: { 'zh-CN': '剪切', 'en-US': 'Cut' },
        accelerator: 'Ctrl+X',
      },
      {
        id: 'menu.edit.copy',
        labelKey: 'menu.edit.copy',
        fallbackLabels: { 'zh-CN': '复制', 'en-US': 'Copy' },
        accelerator: 'Ctrl+C',
      },
      {
      ...
      },
      {
        ...
        fallbackLabels: { 'zh-CN': '查找', 'en-US': 'Find' },
        accelerator: 'Ctrl+F',
      },
      {
        id: 'menu.edit.replace',
        labelKey: 'menu.edit.replace',
        fallbackLabels: { 'zh-CN': '替换', 'en-US': 'Replace' },
        accelerator: 'Ctrl+H',
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 'menu.paragraph.heading_1',
        labelKey: 'menu.paragraph.heading1',
        fallbackLabels: { 'zh-CN': '标题 1', 'en-US': 'Heading 1' },
        accelerator: 'Ctrl+1',
      },
      {
        id: 'menu.paragraph.heading_2',
        labelKey: 'menu.paragraph.heading2',
        fallbackLabels: { 'zh-CN': '标题 2', 'en-US': 'Heading 2' },
        accelerator: 'Ctrl+2',
      },
      {
        id: 'menu.paragraph.heading_3',
        labelKey: 'menu.paragraph.heading3',
        fallbackLabels: { 'zh-CN': '标题 3', 'en-US': 'Heading 3' },
        accelerator: 'Ctrl+3',
      },
      {
        id: 'separator.paragraph.1',
        labelKey: 'separator.paragraph.1',
        fallbackLabels: { 'zh-CN': '', 'en-US': '' },
        separator: true,
      },
      {
        id: 'menu.paragraph.blockquote',
        labelKey: 'menu.paragraph.blockquote',
        fallbackLabels: { 'zh-CN': '引用', 'en-US': 'Blockquote' },
      },
      {
        id: 'menu.paragraph.code_block',
        labelKey: 'menu.paragraph.codeBlock',
        fallbackLabels: { 'zh-CN': '代码块', 'en-US': 'Code Block' },
      },
      {
        id: 'menu.paragraph.table',
        labelKey: 'menu.paragraph.table',
        fallbackLabels: { 'zh-CN': '表格', 'en-US': 'Table' },
      },
      {
        id: 'menu.paragraph.unordered_list',
        labelKey: 'menu.paragraph.unorderedList',
        fallbackLabels: { 'zh-CN': '无序列表', 'en-US': 'Unordered List' },
      },
      {
        id: 'menu.paragraph.ordered_list',
        labelKey: 'menu.paragraph.orderedList',
        fallbackLabels: { 'zh-CN': '有序列表', 'en-US': 'Ordered List' },
      },
      {
        id: 'menu.paragraph.task_list',
        labelKey: 'menu.paragraph.taskList',
        fallbackLabels: { 'zh-CN': '任务列表', 'en-US': 'Task List' },
      },
      {
        id: 'menu.paragraph.horizontal_rule',
        labelKey: 'menu.paragraph.horizontalRule',
        fallbackLabels: { 'zh-CN': '分割线', 'en-US': 'Horizontal Rule' },
      },
      {
        id: 'menu.paragraph.math_block',
        labelKey: 'menu.paragraph.mathBlock',
        fallbackLabels: { 'zh-CN': '数学公式块', 'en-US': 'Math Block' },
        enabled: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        fallbackLabels: { 'zh-CN': '加粗', 'en-US': 'Bold' },
        accelerator: 'Ctrl+B',
      },
      {
        id: 'menu.format.italic',
        labelKey: 'menu.format.italic',
        fallbackLabels: { 'zh-CN': '斜体', 'en-US': 'Italic' },
        accelerator: 'Ctrl+I',
      },
      {
        id: 'menu.format.inline_code',
        labelKey: 'menu.format.inlineCode',
        fallbackLabels: { 'zh-CN': '行内代码', 'en-US': 'Inline Code' },
        accelerator: 'Ctrl+E',
      },
      {
        id: 'menu.format.strike',
        labelKey: 'menu.format.strike',
        fallbackLabels: { 'zh-CN': '删除线', 'en-US': 'Strikethrough' },
        accelerator: 'Shift+Ctrl+X',
      },
      {
        id: 'separator.format.1',
        labelKey: 'separator.format.1',
        fallbackLabels: { 'zh-CN': '', 'en-US': '' },
        separator: true,
      },
      {
        id: 'menu.format.underline',
        labelKey: 'menu.format.underline',
        fallbackLabels: { 'zh-CN': '下划线', 'en-US': 'Underline' },
        accelerator: 'Ctrl+U',
      },
      {
        id: 'menu.format.highlight',
        labelKey: 'menu.format.highlight',
        fallbackLabels: { 'zh-CN': '高亮', 'en-US': 'Highlight' },
        accelerator: 'Shift+Ctrl+H',
      },
      {
        id: 'menu.format.link',
        labelKey: 'menu.format.link',
        fallbackLabels: { 'zh-CN': '链接', 'en-US': 'Link' },
        accelerator: 'Ctrl+K',
      },
      {
        id: 'menu.format.image',
        labelKey: 'menu.format.image',
        fallbackLabels: { 'zh-CN': '图片', 'en-US': 'Image' },
    ...
    items: [
      {
        ...
        fallbackLabels: { 'zh-CN': '显示大纲', 'en-US': 'Show Outline' },
      },
      {
        id: 'menu.view.toggle_sidebar',
        labelKey: 'menu.view.toggleSidebar',
        fallbackLabels: { 'zh-CN': '切换侧边栏', 'en-US': 'Toggle Sidebar' },
        accelerator: 'Ctrl+\\',
      },
      {
        id: 'menu.view.focus_mode',
        labelKey: 'menu.view.focusMode',
        fallbackLabels: { 'zh-CN': '打字机模式', 'en-US': 'Typewriter Mode' },
        accelerator: 'F11',
      },
      {
        id: 'menu.view.source_mode',
        labelKey: 'menu.view.sourceMode',
        fallbackLabels: { 'zh-CN': '源码模式', 'en-US': 'Source Mode' },
        enabled: false,
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 'menu.tools.command_palette',
        labelKey: 'menu.tools.commandPalette',
        fallbackLabels: { 'zh-CN': '命令面板', 'en-US': 'Command Palette' },
        enabled: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        fallbackLabels: { 'zh-CN': '使用文档', 'en-US': 'Documentation' },
        enabled: false,
      },
      {
        id: 'menu.help.release_notes',
        labelKey: 'menu.help.releaseNotes',
        fallbackLabels: { 'zh-CN': '版本说明', 'en-US': 'Release Notes' },
        enabled: false,
      },
      {
        id: 'separator.help.1',
        labelKey: 'separator.help.1',
        fallbackLabels: { 'zh-CN': '', 'en-US': '' },
        separator: true,
      },
      {
        ...
        fallbackLabels: { 'zh-CN': '关于 Writer', 'en-US': 'About Writer' },
        enabled: true,
      },
    ],
  },
