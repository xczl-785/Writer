...
> ⚠️ **当前状态**: 处于活跃的早期开发阶段 (v0.3.x)，核心编辑与文件管理功能已实现闭环。
...
- 🪟 **Windows** (Windows 10 / 11) - *常态化开发与测试平台*
- 🍎 **macOS** (Intel & Apple Silicon) - *常态化开发与测试平台*
- 🐧 **Linux** - *暂未进行全量兼容性验证，处于后续计划线路图中*

## 🚀 下载与使用

由于项目正处于活跃的早期开发阶段（v0.3.x），核心功能正在逐步兑现，部分进阶功能及边角场景尚在开发支持中。

预期的测试版安装程序（包含 Windows、macOS）将陆续通过 [Releases](https://github.com/xczl-785/Writer/releases) 页面发布。
