...
fn build_native_menu_with_locale<R: Runtime>(
    ...
    let file_menu = Submenu::with_items(
        ...
        true,
        &[
            &item(app, locale, "menu.file.new", "??", "New", Some("CmdOrCtrl+N"))?,
            &item(
                app,
                locale,
                "menu.file.open_file",
            ...
            &PredefinedMenuItem::separator(app)?,
            &item(app, locale, "menu.file.save", "??", "Save", Some("CmdOrCtrl+S"))?,
            &item_with_enabled(
                app,
                locale,
                "menu.file.save_as",
            ...
            &PredefinedMenuItem::separator(app)?,
            &item(app, locale, "menu.file.settings", "??", "Settings", None)?,
        ],
    )?;
